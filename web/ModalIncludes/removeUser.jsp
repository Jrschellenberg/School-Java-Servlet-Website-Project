            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<%=request.getContextPath()%>/Admin" method="POST">
                    <div class="form-group">
                        <label for="removeUser" class="col-sm-6 control-label">Remove This User!:</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="removeUser" name="removeUser" placeholder="Username" data-validation="length" data-validation-length="2-30">
                        </div>
                    </div>
