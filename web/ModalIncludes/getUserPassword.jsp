            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<%=request.getContextPath()%>/Admin" method="POST">
                    <div class="form-group">
                        <label for="removeUser" class="col-sm-2 control-label">Enter User Name:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="removeUser" name="retrievePassword" placeholder="Username">
                        </div>
                    </div>
